...
int pContador;  //Variável para contar o número de elementos armazenados na Pilha
...
void Pilha_Construtor()
{
  ...
  pContador = 0;  //Inicia a variável para indicar a quantidade de elementos armazenados na Pilha
}
...
bool Pilha_Vazia()
{
   return Topo == NULL;   //Pela forma como os elementos são Empilhados e Desempilhados (métodos a seguir)
                          ...
                          //Esse comando poderia também ser substituído por pContador == 0
...
int Pilha_Tamanho()
{
    ...
    return pContador;   //É retornado o pContador de elementos, manipulado nos métodos de Empilhar e Desempilhar
}
...
bool Pilha_Empilhar(Aluno Elemento)
{
   ...
   else
   {
       ...
       pContador++;             //Como foi armazenado um novo Elemento, o pContador deve ser incrementado
...
bool Pilha_Desempilhar(Aluno &Elemento)
{
   ...
   if(!Pilha_Vazia())  //primeiro deve-se conferir se a Pilha não está vazia
   {
      ...
      pContador--;          //Como foi removido um Elemento, o pContador deve ser decrementado
...
bool Pilha_Topo(Aluno &Elemento)
{
